...
import { namespaces, getNamespaceByPath, NamespaceConfig } from '../src/namespaces.js';
...
// In-memory session storage (works for Vercel's Node.js runtime with keep-alive)
