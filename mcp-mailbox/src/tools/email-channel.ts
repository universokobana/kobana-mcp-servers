...
import {
  getEmailChannelSchema,
  createEmailChannelSchema,
  updateEmailChannelSchema,
  deleteEmailChannelSchema,
  activateEmailChannelSchema,
  deactivateEmailChannelSchema,
...
export const getEmailChannelTool: ToolDefinition = {
...
export const createEmailChannelTool: ToolDefinition = {
...
export const updateEmailChannelTool: ToolDefinition = {
...
export const deleteEmailChannelTool: ToolDefinition = {
...
export const activateEmailChannelTool: ToolDefinition = {
...
export const deactivateEmailChannelTool: ToolDefinition = {
...
export const emailChannelTools: ToolDefinition[] = [
  getEmailChannelTool,
