...
import {
  getSyncthingChannelSchema,
  createSyncthingChannelSchema,
  updateSyncthingChannelSchema,
  deleteSyncthingChannelSchema,
  activateSyncthingChannelSchema,
  deactivateSyncthingChannelSchema,
  resendSyncthingInvitesSchema,
  updateSyncthingStatusSchema,
...
export const getSyncthingChannelTool: ToolDefinition = {
...
export const createSyncthingChannelTool: ToolDefinition = {
...
export const updateSyncthingChannelTool: ToolDefinition = {
...
export const deleteSyncthingChannelTool: ToolDefinition = {
...
export const activateSyncthingChannelTool: ToolDefinition = {
...
export const deactivateSyncthingChannelTool: ToolDefinition = {
...
export const resendSyncthingInvitesTool: ToolDefinition = {
...
export const updateSyncthingStatusTool: ToolDefinition = {
...
export const syncthingChannelTools: ToolDefinition[] = [
