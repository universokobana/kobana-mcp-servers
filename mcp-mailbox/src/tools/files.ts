...
import {
  listMailboxFilesSchema,
  getMailboxFileSchema,
  createMailboxFileSchema,
  updateMailboxFileSchema,
  deleteMailboxFileSchema,
...
export const listMailboxFilesTool: ToolDefinition = {
...
export const getMailboxFileTool: ToolDefinition = {
...
export const createMailboxFileTool: ToolDefinition = {
...
export const updateMailboxFileTool: ToolDefinition = {
...
export const deleteMailboxFileTool: ToolDefinition = {
