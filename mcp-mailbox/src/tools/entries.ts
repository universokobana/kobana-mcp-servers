...
import {
  listMailboxEntriesSchema,
  getMailboxEntrySchema,
  createMailboxEntrySchema,
  updateMailboxEntrySchema,
  deleteMailboxEntrySchema,
...
export const listMailboxEntriesTool: ToolDefinition = {
...
export const getMailboxEntryTool: ToolDefinition = {
...
export const createMailboxEntryTool: ToolDefinition = {
...
export const updateMailboxEntryTool: ToolDefinition = {
...
export const deleteMailboxEntryTool: ToolDefinition = {
...
export const entriesTools: ToolDefinition[] = [
