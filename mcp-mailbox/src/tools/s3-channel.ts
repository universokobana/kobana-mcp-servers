...
import {
  getS3ChannelSchema,
  createS3ChannelSchema,
  deleteS3ChannelSchema,
  activateS3ChannelSchema,
  deactivateS3ChannelSchema,
...
export const getS3ChannelTool: ToolDefinition = {
...
export const createS3ChannelTool: ToolDefinition = {
...
export const deleteS3ChannelTool: ToolDefinition = {
...
export const activateS3ChannelTool: ToolDefinition = {
...
export const deactivateS3ChannelTool: ToolDefinition = {
...
export const updateS3CredentialsTool: ToolDefinition = {
...
export const s3ChannelTools: ToolDefinition[] = [
  getS3ChannelTool,
  createS3ChannelTool,
  deleteS3ChannelTool,
