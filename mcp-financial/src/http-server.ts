...
function handleInfo(_req: IncomingMessage, res: ServerResponse): void {
  ...
  res.end(JSON.stringify({
    ...
    tools: [
      'list_financial_providers',
      'list_financial_accounts',
      'create_financial_account',
      'get_financial_account',
      'update_financial_account',
      'list_financial_account_balances',
      'create_financial_account_balance',
      'get_financial_account_balance',
      'list_financial_account_commands',
      'get_financial_account_command',
      'list_financial_statement_transactions',
      'sync_financial_statement_transactions',
      'list_financial_statement_transaction_imports',
      'create_financial_statement_transaction_import',
      'get_financial_statement_transaction_import',
    ],
  }));
}
...
httpServer.listen(PORT, HOST, () => {
  console.log(`Kobana MCP Financial Server (HTTP) running on http://${HOST}:${PORT}`);
