...
import { ArticleSearchResult, Article, SearchResponse } from '../types/api.js';
 ...
 */
function parseSearchResults(html: string, baseUrl: string): ArticleSearchResult[] {
 ...
 */
function parseArticleContent(html: string): { title: string; content: string; relatedArticles: ArticleSearchResult[] } {
  let title = '';
  let content = '';
  const relatedArticles: ArticleSearchResult[] = [];
